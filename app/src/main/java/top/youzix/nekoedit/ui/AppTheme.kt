 ...
 *
 * The vendored liquid-glass components need this, and reading it from the composition
 * keeps every layer in agreement with [ThemeController].
 */
...
/** Theme modes offered on the settings page, in display order. */
